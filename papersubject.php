							...
							<div class="row">
								...
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><a href="#">Subject</a> <span class="bread-slash">/</span> </li>
										<li><span class="bread-blod">Add Paper To subject</span> </li>
									</ul>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="admin-pro-accordion-wrap mg-b-15 shadow-reset">
							<form action="includes/papersubject.php" method="post">
							<div class="panel-group adminpro-custon-design" id="accordion">
								<div class="panel panel-default">
									 <?php
                            $fullUrl = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
                if(strpos($fullUrl, "createpaper=exists") == true){
                    echo "<p style='color : red; font-size:20px;'>Paper already exists.</p>";
                }else if(strpos($fullUrl, "createpaper=success") == true){
                    echo "<p style='color : green; font-size:20px;'>Successfully created paper</p>";
                }else if(strpos($fullUrl, "createpaper=notset") == true){
											...
											<div class="">
												<div class="chosen-select-single mg-b-20">
													<select name="subjectid" class="form-control">
														...
														<?php
														$sql1="SELECT id,SubjectName,Level FROM tblsubjects";
														$result1 = mysqli_query($conn,$sql1);
										while($row1 = mysqli_fetch_assoc($result1)){
														?>
														<option value="<?php echo $row1['id'] ?>"><?php echo $row1['SubjectName']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$row1['Level'] ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
											<p>Paper Name</p>
											<div class="">
												<input type="text" name="papername" class="form-control" required="required"></div>
