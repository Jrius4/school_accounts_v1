								...
								<div class="datatable-dashv1-list custom-datatable-overright">
									<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-key-events="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-click-to-select="true" data-toolbar="#toolbar">
										...
										<tbody>
											...
											$id=$_SESSION['ARid'];
												$sql = "SELECT tblresultmt.Marks,tblresultmt.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresultmt join tblclasses on tblclasses.id=tblresultmt.ClassId join tblsubjects on tblsubjects.id=tblresultmt.SubjectId join tblpapers on tblpapers.id=tblresultmt.PaperId WHERE tblresultmt.StudentRoll='$id' AND tblresultmt.Term=3 ORDER BY tblresultmt.id DESC";
												$result = mysqli_query($conn,$sql);
                                   ...
                                   ?>
											...
											<?php
												...
												$id1=$_SESSION['S34id'];
												$sql3 = "SELECT tblresultmt.Marks,tblresultmt.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresultmt join tblclasses on tblclasses.id=tblresultmt.ClassId join tblsubjects on tblsubjects.id=tblresultmt.SubjectId join tblpapers on tblpapers.id=tblresultmt.PaperId WHERE tblresultmt.StudentRoll='$id1' AND tblresultmt.Term=3 ORDER BY tblresultmt.id DESC";
                                   ...
                                   ?>
											...
											<?php
												...
												$id2=$_SESSION['S21id'];
												$sql4 = "SELECT tblresultmt.Marks,tblresultmt.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresultmt join tblclasses on tblclasses.id=tblresultmt.ClassId join tblsubjects on tblsubjects.id=tblresultmt.SubjectId join tblpapers on tblpapers.id=tblresultmt.PaperId WHERE tblresultmt.StudentRoll='$id2' AND tblresultmt.Term=3 ORDER BY tblresultmt.id DESC";
