...
<body class="darklayout">
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><span class="bread-blod">assign subject to teachers</span> </li>
									</ul>
								</div>
							</div>
						</div>
 ...
 <?php
                ...
                if(strpos($fullUrl, "assign=exists") == true){
                    echo "<p style='color : red; font-size:20px;'>Teacher has already been assigned this subject for this level.</p>";
                }else if(strpos($fullUrl, "assign=success") == true){
                    echo "<p style='color : green; font-size:20px;'>Successfully assigned subject to teacher</p>";
                ...
                ?>
							<div class="panel-group adminpro-custon-design" id="accordion">
								<div class="panel panel-default">
									<form action="includes/assignteacher.php" method="post">
											...
											<div class="">
												<div class="chosen-select-single mg-b-20">
													<select name="subjectid" class="form-control" required>
														<option value="">Select</option>
														<?php
										$sql = "SELECT id,SubjectName,Level from tblsubjects";
										$result = mysqli_query($conn,$sql);
										while($row = mysqli_fetch_assoc($result)){
										?>
														<option value="<?php echo $row['id'] ?>"><?php echo $row['SubjectName']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$row['Level'] ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
