...
<body class="darklayout">
    ...
    $years = (int)date('Y',$week);
		...
		$result=mysqli_query($conn,$sql);
												...
												?>
											<img src="uploads/<?php echo $row['profilepic'] ?>" alt="image" style="height: 100px; width: 100px;">
											<?php
		...
		$row1=mysqli_fetch_assoc($result1);
																?>
											<img src="uploads/<?php echo $row1['profilepic'] ?>" alt="image" style="height: 100px; width: 100px;">
											<?php
		...
		$row2=mysqli_fetch_assoc($result2);
												?>
											<img src="uploads/<?php echo $row2['profilepic'] ?>" alt="image" style="height: 100px; width: 100px;">
											<?php
								...
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><span class="bread-blod">M.T</span> </li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="sparkline13-list shadow-reset">
							<div class="sparkline13-hd">
								<div class="main-sparkline13-hd">
									<h1>Mid <span class="table-project-n"> Term</span> </h1>
								...
								<div class="datatable-dashv1-list custom-datatable-overright">
									<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-key-events="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-click-to-select="true" data-toolbar="#toolbar">
										...
										<tbody>
											...
											$id=$_SESSION['ARid'];
												$sql = "SELECT tblresultmt.Marks,tblresultmt.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresultmt join tblclasses on tblclasses.id=tblresultmt.ClassId join tblsubjects on tblsubjects.id=tblresultmt.SubjectId join tblpapers on tblpapers.id=tblresultmt.PaperId WHERE tblresultmt.StudentRoll='$id' AND tblresultmt.Term=1 ORDER BY tblresultmt.id DESC";
												$result = mysqli_query($conn,$sql);
                                   ...
                                   ?>
											...
											<?php
												...
												$id1=$_SESSION['S34id'];
												$sql3 = "SELECT tblresultmt.Marks,tblresultmt.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresultmt join tblclasses on tblclasses.id=tblresultmt.ClassId join tblsubjects on tblsubjects.id=tblresultmt.SubjectId join tblpapers on tblpapers.id=tblresultmt.PaperId WHERE tblresultmt.StudentRoll='$id1' AND tblresultmt.Term=1 ORDER BY tblresultmt.id DESC";
                                   ...
                                   ?>
											...
											<?php
												...
												$id2=$_SESSION['S21id'];
												$sql4 = "SELECT tblresultmt.Marks,tblresultmt.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresultmt join tblclasses on tblclasses.id=tblresultmt.ClassId join tblsubjects on tblsubjects.id=tblresultmt.SubjectId join tblpapers on tblpapers.id=tblresultmt.PaperId WHERE tblresultmt.StudentRoll='$id2' AND tblresultmt.Term=1 ORDER BY tblresultmt.id DESC";
