...
<head>
	...
	<script>
	function getPapers(value) {
    $.ajax({
    type: "POST",
    url: "get_student.php",
    data:'subjectidp='+value,
	...
	<div class="wrapper-pro">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="breadcome-heading">
										<h2>Set total percentage of a paper in a subject</h2>
									</div>
								</div>
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><span class="bread-blod">set</span> </li>
									</ul>
								</div>
							</div>
						</div>
		...
		<div class="adminpro-accordion-area">
			<div class="container-fluid">
                ...
                if(strpos($fullUrl, "paper=alreadyset") == true){
                    echo "<p style='color : red; font-size:20px;'>Paper Percentage for this subject already set</p>";
                }else if(strpos($fullUrl, "paper=greaterthan100") == true){
                ...
                ?>
							<form action="includes/setpaperpercentage.php" method="post">
								...
								<div class="panel panel-default">
									...
									<div id="form" class="panel-collapse panel-ic collapse in">
										<div class="form admin-panel-content animated bounce">
											...
											<?php
											$tun=$_SESSION[ 'teachername' ];
											$sql="SELECT id FROM tblteachers WHERE UserName='$tun';";
											...
											<div class="">
												<div class="chosen-select-single mg-b-20">
													<select name="subjectid" class="form-control" onChange="getPapers(this.value);">
														<option>Select</option>
														<?php
														$status=0;
			$stmt = "SELECT tblsubjects.SubjectName,tblsubjects.id,tblsubjects.Level FROM teachersubjectcombination join tblsubjects on tblsubjects.id=teachersubjectcombination.SubjectId WHERE 
			teachersubjectcombination.TeacherId=$tid AND teachersubjectcombination.Status!=$status order by tblsubjects.SubjectName;";
					...
					<?php echo $rows['SubjectName']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$rows['Level'] ?>
											...
											<div class="">
												<div class="login-horizental login-btn-inner">
													<button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="submit">Set</button>
												</div>
											</div>
										</div>
									</div>
