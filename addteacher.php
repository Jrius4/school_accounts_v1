							...
							<div class="row">
								...
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><span class="bread-blod">Add Teacher</span> </li>
									</ul>
								</div>
							</div>
						</div>
...
<?php
                ...
                if(strpos($fullUrl, "add=success") == true){
                    echo "<p style='color : green; font-size:20px;'>Successfully registered teacher</p>";
                }else if(strpos($fullUrl, "add=userexists") == true){
                    echo "<p style='color : red; font-size:20px;'>This teacher is already registered.</p>";
                ...
                ?>
							<div class="panel-group adminpro-custon-design" id="accordion">
								<div class="panel panel-default">
									<form action="includes/addteacher.php" method="post" enctype="multipart/form-data">
										<div id="form" class="panel-collapse panel-ic collapse in">
											<div class="form admin-panel-content animated bounce">
												...
												<p>User Name</p>
												<div class="">
													<input type="text" name="username" class="form-control" required="required" id="success"> </div>
												<p>Password</p>
												<div class="">
													<input type="password" name="userpassword" class="form-control" required="required"> </div>
												<p>Gender</p>
												<div class="">
												...
												<div class="">
													<div class="login-horizental login-btn-inner">
														<button class="btn btn-sm btn-primary login-submit-cs" name="submit" type="submit">Add teacher</button>
													</div>
												</div>
											</div>
										</div>
