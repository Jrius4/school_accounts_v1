...
<div class="col-lg-6">
	<div class="breadcome-heading">
		<h2>Termly Results</h2>
	</div>
</div>
<div class="col-lg-6">
	<ul class="breadcome-menu">
		<li><a href="#">Home</a> <span class="bread-slash">/</span> </li>
		<li><span class="bread-blod">Declare results</span> </li>
	</ul>
</div>
</div>
</div>
...
<div class="admin-pro-accordion-wrap mg-b-15 shadow-reset">
                ...
                if(strpos($fullUrl, "add=success") == true){
                    echo "<p style='color : green; font-size:20px;'>Successfully declared results for this class</p>";
...
<div class="panel panel-default">
	<form action="includes/declareresults.php" method="post">
		...
		?>
				...
				<div class="">
					<div class="chosen-select-single mg-b-20">
						...
						<?php
							$sql2="SELECT id,ClassName FROM tblclasses WHERE ClassTeacherId=$tid";
		...
		$row2 = mysqli_fetch_assoc($result2);
					...
					<div class="">
					<input type="hidden" name="classids" value="<?php echo $row2['id'] ?>">
					</div>
				</div>
				<p>Term</p>
				<div class="">
				...
				<div class="">
					<div class="login-horizental login-btn-inner">
						<button class="btn btn-sm btn-primary login-submit-cs" name="submit" type="submit">Declare Results</button>
					</div>
				</div>
			</div>
		</div>
