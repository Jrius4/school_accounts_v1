								...
								<div class="datatable-dashv1-list custom-datatable-overright">
									<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-key-events="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-click-to-select="true" data-toolbar="#toolbar">
										...
										<tbody>
											...
											$id=$_SESSION['ARid'];
												$sql = "SELECT tblresulteot.Marks,tblresulteot.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresulteot join tblclasses on tblclasses.id=tblresulteot.ClassId join tblsubjects on tblsubjects.id=tblresulteot.SubjectId join tblpapers on tblpapers.id=tblresulteot.PaperId WHERE tblresulteot.StudentId=$id AND tblresulteot.Term=3 ORDER BY tblresulteot.id DESC";
												$result = mysqli_query($conn,$sql);
                                   ...
                                   ?>
											...
											<?php
												...
												$id1=$_SESSION['S34id'];
												$sql3 = "SELECT tblresulteot.Marks,tblresulteot.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresulteot join tblclasses on tblclasses.id=tblresulteot.ClassId join tblsubjects on tblsubjects.id=tblresulteot.SubjectId join tblpapers on tblpapers.id=tblresulteot.PaperId WHERE tblresulteot.StudentId=$id1 AND tblresulteot.Term=3 ORDER BY tblresulteot.id DESC";
                                   ...
                                   ?>
											...
											<?php
												...
												$id2=$_SESSION['S21id'];
												$sql4 = "SELECT tblresulteot.Marks,tblresulteot.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresulteot join tblclasses on tblclasses.id=tblresulteot.ClassId join tblsubjects on tblsubjects.id=tblresulteot.SubjectId join tblpapers on tblpapers.id=tblresulteot.PaperId WHERE tblresulteot.StudentId=$id2 AND tblresulteot.Term=3 ORDER BY tblresulteot.id DESC";
