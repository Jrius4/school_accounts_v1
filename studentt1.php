							...
							<div class="row">
								...
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><span class="bread-blod">Beginning of Term</span> </li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="admin-pro-accordion-wrap mg-b-15 shadow-reset">
							...
							<div class="panel-group adminpro-custon-design" id="accordion">
								<div class="panel panel-default">
									<form action="includes/teacher1bot.php" method="post">
										...
										?>
												...
												<div class="">
													<div class="chosen-select-single mg-b-20">
														...
														<?php
															$sql2="SELECT tblclasses.ClassName,tblclasses.id FROM teacherclasscombination join tblclasses on tblclasses.id=teacherclasscombination.ClassId WHERE teacherclasscombination.TeacherId=$id;";
										...
										while($row2 = mysqli_fetch_assoc($result2)){
												...
												<div class="">
													<div id="reslt" class="chosen-select-single mg-b-20">
