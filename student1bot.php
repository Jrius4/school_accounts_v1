		...
		$row2=mysqli_fetch_assoc($result2);
								...
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><span class="bread-blod">B.O.T</span> </li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="sparkline13-list shadow-reset">
							<div class="sparkline13-hd">
								<div class="main-sparkline13-hd">
									<h1>Beginning <span class="table-project-n">of Term</span> </h1>
								...
								<div class="datatable-dashv1-list custom-datatable-overright">
									<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-key-events="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-click-to-select="true" data-toolbar="#toolbar">
										...
										<tbody>
											...
											if($c==5 || $c==6){
											$rn=$_SESSION['ARid'];
												$sql = "SELECT tblresult.Marks,tblresult.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresult join tblclasses on tblclasses.id=tblresult.ClassId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblpapers on tblpapers.id=tblresult.PaperId WHERE tblresult.StudentRoll='$rn' AND Term=1 ORDER BY tblresult.id DESC";
												$result = mysqli_query($conn,$sql);
                                   ...
                                   ?>
											...
											<?php
												...
												$id1=$_SESSION['S34id'];
												$sql3 = "SELECT tblresult.Marks,tblresult.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresult join tblclasses on tblclasses.id=tblresult.ClassId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblpapers on tblpapers.id=tblresult.PaperId WHERE tblresult.StudentRoll='$id1' AND Term=1 ORDER BY tblresult.id DESC";
                                   ...
                                   ?>
											...
											<?php
												...
												$id2=$_SESSION['S21id'];
												$sql4 = "SELECT tblresult.Marks,tblresult.Year,tblclasses.ClassName,tblsubjects.SubjectName,tblpapers.PaperName FROM tblresult join tblclasses on tblclasses.id=tblresult.ClassId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblpapers on tblpapers.id=tblresult.PaperId WHERE tblresult.StudentRoll='$id2' AND Term=1 ORDER BY tblresult.id DESC";
