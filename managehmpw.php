                ...
                <div class="col-lg-6">
                  <ul class="breadcome-menu">
                    <li><a href="#">Home</a> <span class="bread-slash">/</span> </li>
					  <li><a href="#">Manage Admin Password</a> <span class="bread-slash">/</span> </li>
                ...
                ?>
									<div id="form" class="panel-collapse panel-ic collapse in">
										<div class="form admin-panel-content animated bounce">
											...
											<p>New UserName</p>
											<div class="">
												<input type="text" value="<?php echo $_SESSION['hmname'] ?>" name="newusername" class="form-control" required="required"> </div>
											<p>New Password</p>
											<div class="">
												<input type="password" name="newuserpassword" class="form-control" required="required" id="success">
