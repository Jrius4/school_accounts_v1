    ...
    $years = (int)date('Y',$week);
			...
			Email:info@friendsacademy.co.ug</span>
				...
				$result = mysqli_query( $conn, $sql );
						...
						?>
						<img src="uploads/<?php echo $row['profilepic']; ?>" height="150px" width="150px" alt=""/>
					</div>
					<div class="col-lg-12">
						<br/>
						<div class="col-lg-4">
...
<td colspan="7" align="center" style="color: black;"><a href="pdfs21.php"><i class="fa fa-print fa-2x" aria-hidden="true" style="cursor:pointer" ></i></a></td>
                                                             </tr>
...
<div class="admin-pro-accordion-wrap mg-b-15 shadow-reset" style="background-color: white;color: black;">
    ...
    $years = (int)date('Y',$week);
					$cid=$_SESSION['class'];
					$sql5="SELECT id FROM tbldeclare WHERE Year=$years AND Term=2 AND ClassId=$cid";
					$result5=mysqli_query($conn,$sql5);
					$count = mysqli_num_rows($result5);
					if($count == 1){
						?>
...
<td colspan="7" align="center" style="color: black;"><a href="pdf2t21.php"><i class="fa fa-print fa-2x" aria-hidden="true" style="cursor:pointer" ></i></a></td>
                                                             </tr>
									<!--																		compiled report info end-->
								</tbody>
							</table>
...
<div class="admin-pro-accordion-wrap mg-b-15 shadow-reset" style="background-color: white;color: black;">
    ...
    $years = (int)date('Y',$week);
					$cid=$_SESSION['class'];
					$sql5="SELECT id FROM tbldeclare WHERE Year=$years AND Term=3 AND ClassId=$cid";
					$result5=mysqli_query($conn,$sql5);
					$count = mysqli_num_rows($result5);
					if($count == 1){
						?>
...
//																				create a method to sort the array
									...
									<tr>
										...
										<?php
											if($arrs < 32){
												if($cid==1){
													echo "Promoted to Senior Two";
												}else if($cid==2){
													echo "Promoted to Senior Three";
												}
											}else if($arrs >= 33 && $arrs <= 50){
												echo "Parent expected to contact and report to school to discuss poor performance";
											}else if($arrs >= 51){
												if($cid==1){
													echo "Advised to repeat Senior One";
												}else if($cid==2){
													echo "Advised to repeat Senior Two";
												}
											}
											?>
										</td>
...
<td colspan="7" align="center" style="color: black;"><a href="pdf3t21.php"><i class="fa fa-print fa-2x" aria-hidden="true" style="cursor:pointer" ></i></a></td>
                                                             </tr>
									<!--																		compiled report info end-->
								</tbody>
							</table>
