							...
							<div class="row">
								...
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><span class="bread-blod">view clases</span> </li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="sparkline13-graph">
								<div class="datatable-dashv1-list custom-datatable-overright">
									<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-key-events="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-click-to-select="true" data-toolbar="#toolbar">
										...
										<tbody>
											<?php 
												$sql = "SELECT tblclasses.ClassName,tblclasses.id,tblclasses.StreamName,tblclasses.NickName,tblclasses.Level,tblclasses.CreationDate,tblclasses.UpdationDate,tblteachers.FullName from tblclasses join tblteachers on tblteachers.id =tblclasses.ClassTeacherId";
