...
$pdf->Cell(70,5,'',0,0);$pdf->Cell(50,5,'',0,0);$pdf->Cell(50,5,'',0,1);
$pdf->Cell(70,5,$ct,0,0);$pdf->Cell(50,5,'Term: Three',0,0);$pdf->Cell(50,5,$g,0,1);
//dummycells for space
$pdf->Cell(70,5,'',0,0);$pdf->Cell(50,5,'',0,0);$pdf->Cell(50,5,'',0,1);
...
$row=mysqli_fetch_assoc($result);
	$s1=$row['fn'];
$sql5="SELECT SUM(FinalMark) AS fn1 FROM tblfinalmt WHERE SubjectId=$si AND StudentRoll='$sRoll' AND Term=3 AND Year=$years;;";
$result5=mysqli_query($conn,$sql5);
$row5=mysqli_fetch_assoc($result5);
$s2=$row5['fn1'];
$sql6="SELECT SUM(FinalMark) AS fn2 FROM tblfinaleot WHERE SubjectId=$si AND StudentRoll='$sRoll' AND Term=3 AND Year=$years;;";
...
$pdf->Cell(60,10,$subject,1,0,'L',true);$pdf->Cell(18,10,$s1,1,0,'C',true);
$pdf->Cell(18,10,$s2,1,0,'C',true);
$pdf->Cell(18,10,$s3,1,0,'C',true);$pdf->Cell(18,10,$avg,1,0,'C',true);
$pdf->Cell(18,10,$m,1,0,'C',true);$pdf->Cell(40,10,$cm,1,1,'C',true);
	}
...
$pdf->Cell(60,10,$subject1,1,0,'L',true);$pdf->Cell(18,10,$s1,1,0,'C',true);
$pdf->Cell(18,10,$s2,1,0,'C',true);
$pdf->Cell(18,10,$s3,1,0,'C',true);$pdf->Cell(18,10,$avg,1,0,'C',true);
$pdf->Cell(18,10,$m,1,0,'C',true);$pdf->Cell(40,10,$cm,1,1,'C',true);
...
$pdf->Cell(78,10,'Aggregate in best 8',1,0,'L',true);$pdf->Cell(18,10,$arrs,1,0,'C',true);
$pdf->Cell(76,10,'Division',1,0,'L',true);$pdf->Cell(18,10,$dv,1,1,'C',true);
...
$pdf->Cell(80,10,'Class Teacher\'s Comment',1,0,'L',true);$pdf->Cell(110,10,$ctc,1,1,'L',true);
if($arrs < 32){
...
$pdf->Cell(80,10,'Head Teacher\'s Comment',1,0,'L',true);$pdf->Cell(110,10,$htc,1,1,'L',true);
...
$pdf->Cell(80,10,'Unpaid fees',1,0,'L',true);$pdf->Cell(32,10,$b,1,0,'C',true);
$sql="SELECT nxtdate FROM tblnxtdate ORDER BY id DESC ";
$result=mysqli_query($conn,$sql);
$row=mysqli_fetch_assoc($result);
$dt= $row['nxtdate'];
$pdf->Cell(50,10,'Next term begins on',1,0,'L',true);$pdf->Cell(28,10,$dt,1,1,'C',true);
