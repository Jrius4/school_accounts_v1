...
$pdf->Cell(70,5,'',0,0);$pdf->Cell(50,5,'',0,0);$pdf->Cell(50,5,'',0,1);
$pdf->Cell(70,5,$ct,0,0);$pdf->Cell(50,5,'Term: Two',0,0);$pdf->Cell(50,5,$g,0,1);
//dummycells for space
$pdf->Cell(70,5,'',0,0);$pdf->Cell(50,5,'',0,0);$pdf->Cell(50,5,'',0,1);
...
$row=mysqli_fetch_assoc($result);
	$s1=$row['fn'];
$sql5="SELECT SUM(FinalMark) AS fn1 FROM tblfinalmt WHERE SubjectId=$si AND StudentRoll='$sRoll' AND Term=2 AND Year=$years;;";
$result5=mysqli_query($conn,$sql5);
$row5=mysqli_fetch_assoc($result5);
$s2=$row5['fn1'];
$sql6="SELECT SUM(FinalMark) AS fn2 FROM tblfinaleot WHERE SubjectId=$si AND StudentRoll='$sRoll' AND Term=2 AND Year=$years;;";
