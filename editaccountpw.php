                ...
                <div class="col-lg-6">
                  <ul class="breadcome-menu">
                    <li><a href="#">Home</a> <span class="bread-slash">/</span> </li>
					  <li><a href="#">Manage User Accounts</a> <span class="bread-slash">/</span> </li>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="admin-pro-accordion-wrap mg-b-15 shadow-reset">
							...
							<form action="includes/editaccountpw.php" method="post">
								...
								<div class="panel panel-default">
									...
									$sid=intval($_GET['editaccid']);
										...
										?>
											<p>New UserName</p>
											<div class="">
												<input type="text" value="<?php echo $row['userName'] ?>" name="newusername" class="form-control" required="required"> </div>
											<p>New Password</p>
											<div class="">
												<input type="password" name="newuserpassword" class="form-control" required="required" id="success"></div>
											<div class="">
