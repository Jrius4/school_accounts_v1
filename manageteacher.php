							...
							<div class="row">
								...
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><span class="bread-blod">Manage teachers</span> </li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="sparkline13-list shadow-reset">
							<div class="sparkline13-hd">
								<div class="main-sparkline13-hd">
									<h1>View <span class="table-project-n">Teachers</span> Info</h1>
                ...
                ?>
								<div class="datatable-dashv1-list custom-datatable-overright">
									<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-key-events="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-click-to-select="true" data-toolbar="#toolbar">
										...
										?>
											<tr>
												<td><img src="uploads/<?php echo $row['img'] ?>" alt="image" width="100px" height="100px"></td>
												<td><?php echo $row['FullName'] ?></td>
												<td><?php echo $row['UserName'] ?></td>
												<td><?php echo $row['Gender'] ?></td>
												<td><?php echo $row['CreationDate'] ?></td>
											<td class='datatable-ct'>
											<a href="editteacher.php?teacherid=<?php echo $row['id'] ;?>" style='color: #4E52F3'><i class="fa fa-edit" title="Edit Record"></i> </a></td>
												</tr>
                                  <?php
												 }
												?>
