							...
							<div class="row">
								...
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><span class="bread-blod">Edit class info</span> </li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="admin-pro-accordion-wrap mg-b-15 shadow-reset">
							...
							<div class="panel-group adminpro-custon-design" id="accordion">
								<div class="panel panel-default">
									...
									<form action="includes/editclass.php" method="post">
										<?php
									$sid=intval($_GET['classid']);
										$sql = "SELECT * from tblclasses where id=$sid";
									...
									<div id="form" class="panel-collapse panel-ic collapse in">
										<div class="form admin-panel-content animated bounce">
											<p>Class Name</p>
											<div class="">
												<input type="text" name="classname" value="<?php echo $row['ClassName'] ?>" class="form-control" required="required" disabled> </div>
											...
											<div class="">
												<div class="chosen-select-single mg-b-20">
													<select name="classteacherid" class="select2_demo_3 form-control">
