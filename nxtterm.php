	...
	<div class="wrapper-pro">
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><a href="#">Next Term</a> <span class="bread-slash">/</span> </li>
										<li><span class="bread-blod">Set Date</span> </li>
									</ul>
								</div>
							</div>
						</div>
		...
		<div class="adminpro-accordion-area">
			<div class="container-fluid">
                ...
                if(strpos($fullUrl, "date=success") == true){
                    echo "<p style='color : green; font-size:20px;'>Successfully set next term's date</p>";
                }else if(strpos($fullUrl, "date=notset") == true){
                    echo "<p style='color : red; font-size:20px;'>Fatal Error. Contact system administrator for assistance</p>";
                }
                ?>
							<form action="includes/nxtterm.php" method="post">
								...
								<div class="panel panel-default">
									...
									<div id="form" class="panel-collapse panel-ic collapse in">
										<div class="form admin-panel-content animated bounce">
											<p>Start Date</p>
											<div class="">
												<input type="date" name="nxtdate" class="form-control datepicker" required="required"> </div>
