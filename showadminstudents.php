							...
							<div class="row">
								...
								<div class="col-lg-6">
									<ul class="breadcome-menu">
										...
										<li><span class="bread-blod">Show all students</span> </li>
									</ul>
								</div>
							</div>
						</div>
									...
									<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-key-events="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-click-to-select="true" data-toolbar="#toolbar">
										<thead>
											<tr>
												...
												<th data-field="email">Stream Name</th>
												<th data-field="phone">Short Name</th>
												<th data-field="company">Level</th>
												<th data-field="task">Class Teacher</th>
												<th data-field="date">Date Created</th>
												<th data-field="price">Date Updated</th>
										...
										<tbody>
											<tr>
												...
												<td>Jul 14, 2018</td>
												<td>$5455</td>
												<td class="datatable-ct"><a href="editclass.php" style="color: #4E52F3"> <i class="fa fa-edit"></a></i>
												</td>
											</tr>
											<tr>
												...
												<td>fab 2, 2018</td>
												<td>$8756</td>
												<td class="datatable-ct"><i class="fa fa-edit"></i>
												</td>
											</tr>
										</tbody>
									</table>
