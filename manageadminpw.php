		...
		<div class="adminpro-accordion-area">
			<div class="container-fluid">
                ...
                if(strpos($fullUrl, "adminpw=success") == true){
                    echo "<p style='color : green; font-size:20px;'>Successfully changed password</p>";
                ...
                ?>
							<form action="includes/manageadminpw.php" method="post">
								...
								<div class="panel panel-default">
									...
									<div id="form" class="panel-collapse panel-ic collapse in">
										<div class="form admin-panel-content animated bounce">
											...
											<p>UserName</p>
											<div class="">
												<input type="text" value="<?php echo $_SESSION['adminname'] ?>" name="newusername" class="form-control" disabled> </div>
											<p>New Password</p>
											<div class="">
