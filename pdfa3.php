...
$sid2 = $row3[ 'id' ];
											...
											//											bot marks start
												$paid1 = $paid[ 0 ];
												$sql5 = "SELECT FinalMark AS fn1 FROM tblfinal WHERE SubjectId=$s12 AND StudentRoll='$sRoll' AND PaperId=$paid1 AND Term=3;";
												$result5 = mysqli_query( $conn, $sql5 );
												$row5 = mysqli_fetch_assoc( $result5 );
												$botp12= $row5[ 'fn1' ];
//											bot end
...
//											mt start
											$sql6 = "SELECT FinalMark AS fn1 FROM tblfinalmt WHERE SubjectId=$s12 AND StudentRoll='$sRoll' AND PaperId=$paid1 AND Term=3;";
												$result6 = mysqli_query( $conn, $sql6 );
												$row6 = mysqli_fetch_assoc( $result6 );
											$mtp12=$row6[ 'fn1' ];
//											mt end
//											eot start
											$sql7 = "SELECT FinalMark AS fn1 FROM tblfinaleot WHERE SubjectId=$s12 AND StudentRoll='$sRoll' AND PaperId=$paid1 AND Term=3;";
												$result7 = mysqli_query( $conn, $sql7 );
												$row7 = mysqli_fetch_assoc( $result7 );
											$eotp12=$row7[ 'fn1' ];
//											eot end
...
//											bot start
											$paid2 = $paid[1];
												$sql8 = "SELECT FinalMark AS fn1 FROM tblfinal WHERE SubjectId=$s12 AND StudentRoll='$sRoll' AND PaperId=$paid2 AND Term=3;";
												$result8 = mysqli_query( $conn, $sql8 );
												$row8 = mysqli_fetch_assoc( $result8 );
												$botp22=$row8[ 'fn1' ];
//											bot end
//										mt start
												$sql9 = "SELECT FinalMark AS fn1 FROM tblfinalmt WHERE SubjectId=$s12 AND StudentRoll='$sRoll' AND PaperId=$paid2 AND Term=3;";
												$result9 = mysqli_query( $conn, $sql9 );
												$row9 = mysqli_fetch_assoc( $result9 );
												$mtp22=$row9[ 'fn1' ];
//											mt end
//											eot start
												$sql10 = "SELECT FinalMark AS fn1 FROM tblfinaleot WHERE SubjectId=$s12 AND StudentRoll='$sRoll' AND PaperId=$paid2 AND Term=3;";
												$result10 = mysqli_query( $conn, $sql10 );
												$row10 = mysqli_fetch_assoc( $result10 );
												$eotp22=$row10[ 'fn1' ];
//											eot end
...
//											bot start
												...
												$sql11 = "SELECT FinalMark AS fn1 FROM tblfinal WHERE SubjectId=$s12 AND StudentRoll='$sRoll' AND PaperId=$paid3 AND Term=3;";
												$result11 = mysqli_query( $conn, $sql11 );
												$row11 = mysqli_fetch_assoc( $result11 );
												$botp32=$row11[ 'fn1' ];
//											bot end
//											mt start
											$sql12 = "SELECT FinalMark AS fn1 FROM tblfinalmt WHERE SubjectId=$s12 AND StudentRoll='$sRoll' AND PaperId=$paid3 AND Term=3;";
												$result12 = mysqli_query( $conn, $sql12 );
												$row12 = mysqli_fetch_assoc( $result12 );
												$mtp32=$row12[ 'fn1' ];
//											mt end
//											eot start
												$sql13 = "SELECT FinalMark AS fn1 FROM tblfinaleot WHERE SubjectId=$s12 AND StudentRoll='$sRoll' AND PaperId=$paid3 AND Term=3;";
												$result13 = mysqli_query( $conn, $sql13 );
												$row13 = mysqli_fetch_assoc( $result13 );
												$eotp32=$row13[ 'fn1' ];
												}
...
$sid = $row3[ 'id' ];
											...
											//											bot marks start
												$paid1 = $paid[ 0 ];
												$sql5 = "SELECT FinalMark AS fn1 FROM tblfinal WHERE SubjectId=$s13 AND StudentRoll='$sRoll' AND PaperId=$paid1 AND Term=3;";
												$result5 = mysqli_query( $conn, $sql5 );
												$row5 = mysqli_fetch_assoc( $result5 );
												$botp13=$row5[ 'fn1' ];
//											bot end
...
//											mt start
											$sql6 = "SELECT FinalMark AS fn1 FROM tblfinalmt WHERE SubjectId=$s13 AND StudentRoll='$sRoll' AND PaperId=$paid1 AND Term=3;";
												$result6 = mysqli_query( $conn, $sql6 );
												$row6 = mysqli_fetch_assoc( $result6 );
												$mtp13=$row6[ 'fn1' ];
//											mt end
//											eot start
											$sql7 = "SELECT FinalMark AS fn1 FROM tblfinaleot WHERE SubjectId=$s13 AND StudentRoll='$sRoll' AND PaperId=$paid1 AND Term=3;";
												$result7 = mysqli_query( $conn, $sql7 );
												$row7 = mysqli_fetch_assoc( $result7 );
												$eotp13=$row7[ 'fn1' ];
//											eot end
...
//											bot start
											$paid2 = $paid[1];
												$sql8 = "SELECT FinalMark AS fn1 FROM tblfinal WHERE SubjectId=$s13 AND StudentRoll='$sRoll' AND PaperId=$paid2 AND Term=3;";
												$result8 = mysqli_query( $conn, $sql8 );
												$row8 = mysqli_fetch_assoc( $result8 );
												$botp23=$row8[ 'fn1' ];
//											bot end
//										mt start
												$sql9 = "SELECT FinalMark AS fn1 FROM tblfinalmt WHERE SubjectId=$s13 AND StudentRoll='$sRoll' AND PaperId=$paid2 AND Term=3;";
												$result9 = mysqli_query( $conn, $sql9 );
												$row9 = mysqli_fetch_assoc( $result9 );
												$mtp23=$row9[ 'fn1' ];
//											mt end
//											eot start
												$sql10 = "SELECT FinalMark AS fn1 FROM tblfinaleot WHERE SubjectId=$s13 AND StudentRoll='$sRoll' AND PaperId=$paid2 AND Term=3;";
												$result10 = mysqli_query( $conn, $sql10 );
												$row10 = mysqli_fetch_assoc( $result10 );
												$eotp23=$row10[ 'fn1' ];
//											eot end
...
//											bot start
												...
												$sql11 = "SELECT FinalMark AS fn1 FROM tblfinal WHERE SubjectId=$s13 AND StudentRoll='$sRoll' AND PaperId=$paid3 AND Term=3;";
												$result11 = mysqli_query( $conn, $sql11 );
												$row11 = mysqli_fetch_assoc( $result11 );
													$botp33=$row11[ 'fn1' ];
//											bot end
//											mt start
											$sql12 = "SELECT FinalMark AS fn1 FROM tblfinalmt WHERE SubjectId=$s13 AND StudentRoll='$sRoll' AND PaperId=$paid3 AND Term=3;";
												$result12 = mysqli_query( $conn, $sql12 );
												$row12 = mysqli_fetch_assoc( $result12 );
													$mtp33=$row12[ 'fn1' ];
//											mt end
//											eot start
												$sql13 = "SELECT FinalMark AS fn1 FROM tblfinaleot WHERE SubjectId=$s13 AND StudentRoll='$sRoll' AND PaperId=$paid3 AND Term=3;";
												$result13 = mysqli_query( $conn, $sql13 );
												$row13 = mysqli_fetch_assoc( $result13 );
													$eotp33=$row13[ 'fn1' ];
												}
...
$paidz[]="";
												...
												$paper2s= $pa[ 1 ];
													$paidz1 = $paidz[0];
//											bot paper1
												$sql5 = "SELECT tblfinal.FinalMark FROM tblfinal WHERE StudentRoll='$sRoll' AND Term=3 AND Year=$years AND SubjectId=$s1s AND Paperid=$paidz1";
												$result5 = mysqli_query( $conn, $sql5 );
												$row5 = mysqli_fetch_assoc( $result5 );
												$botp1s=$row5['FinalMark'];
//											mt paper 1
											$sql6 = "SELECT tblfinalmt.FinalMark FROM tblfinalmt WHERE StudentRoll='$sRoll' AND Term=3 AND Year=$years AND SubjectId=$s1s AND Paperid=$paidz1";
												$result6 = mysqli_query( $conn, $sql6 );
												$row6 = mysqli_fetch_assoc( $result6 );
												$mtp1s=$row6['FinalMark'];
//											eot paper1
											$sql7 = "SELECT tblfinaleot.FinalMark FROM tblfinaleot WHERE StudentRoll='$sRoll' AND Term=3 AND Year=$years AND SubjectId=$s1s AND Paperid=$paidz1";
												$result7 = mysqli_query( $conn, $sql7 );
												$row7 = mysqli_fetch_assoc( $result7 );
...
//											bot paper2
												$sql8 = "SELECT tblfinal.FinalMark FROM tblfinal WHERE StudentRoll='$sRoll' AND Term=3 AND Year=$years AND SubjectId=$s1s AND Paperid=$paid2";
												$result8 = mysqli_query( $conn, $sql8 );
												$row8 = mysqli_fetch_assoc( $result8 );
												$botp2s=$row8['FinalMark'];
//											mt paper 2
											$sql9 = "SELECT tblfinalmt.FinalMark FROM tblfinalmt WHERE StudentRoll='$sRoll' AND Term=3 AND Year=$years AND SubjectId=$s1s AND Paperid=$paid2";
												$result9 = mysqli_query( $conn, $sql9 );
												$row9 = mysqli_fetch_assoc( $result9 );
												$mtp2s=$row9['FinalMark'];
//											eot paper2
											$sql10 = "SELECT tblfinaleot.FinalMark FROM tblfinaleot WHERE StudentRoll='$sRoll' AND Term=3 AND Year=$years AND SubjectId=$s1s AND Paperid=$paid2";
												$result10 = mysqli_query( $conn, $sql10 );
												$row10 = mysqli_fetch_assoc( $result10 );
